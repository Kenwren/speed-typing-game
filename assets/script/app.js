...
const soundBgMusic = new Audio('./assets/audio/event-horizon.mp3');
const soundStartGame = new Audio('./assets/audio/start.mp3');
const audioFeedBack = new Audio('../assets/audio/proceed.mp3');
const soundWin = new Audio('./assets/audio/start.mp3');
const soundGameOver = new Audio('./assets/audio/over.mp3');
